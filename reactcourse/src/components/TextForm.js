...
export default function TextForm(props) {
    ...
    const placeholdertext = "Enter your text in above text area to preview";
  ...
  return (
    ...
    <div className={`container bg-${props.mode}`} data-bs-theme={`${props.mode}`}>
        <div className={`container-fluid mb-3 my-3`}>
            <label htmlFor="exampleFormControlTextarea1"  className={`form-label text-${props.mode === 'light'? 'dark':'light'}`}>Enter your text to analyze:</label>
            <textarea className="form-control  mb-3" onChange={handleOnchange} id="exampleFormControlTextarea1" value={text} rows="5"></textarea>
            <button className="btn btn-sm btn-primary mx-1 my-1" onClick={handleUpperCase}>Change to UPPERCASE</button>
            <button className="btn btn-sm btn-primary mx-1 my-1" onClick={handleLowerCase}>Change to LOWERCASE</button>
            <button className="btn btn-sm btn-primary mx-1 my-1" onClick={handleCopyTest}>Copy Text</button>
            <button className="btn btn-sm btn-primary mx-1 my-1" onClick={handleExtraSpace}>Reomve Extra Space</button>
            <button className="btn btn-sm btn-primary mx-1 my-1" onClick={handleClearTextArea}>Clear</button>
